...
// the shadows are still pixalated even after the increase in resolution, it can be solved using PCF : Percentage Closer Flitering  
// instead of sampling from one pixel we are going to take ll 8 from the ones around and get the average shadow of those 9 pixels. 

...
void CreateObjects(){
    ...
    Object* ground2 = new Object(geometry::cube, Textures::Brick(), Materials::Dull(), glm::vec3(0., 10, 0.), glm::vec3(0.), glm::vec3(general::sceneSize.x/5., general::floorThickness, general::sceneSize.z/5), glm::vec3(1., 1., 1.));

...
int main()
{
    ...
    Shader shaderLTC("../../src_learnopgl/7.area_light.vs", "../../src_learnopgl/7.area_light.fs");
    ltcShaderPtr = &shaderLTC;
    Shader shaderLightPlane("../../src_learnopgl/7.light_plane.vs", "../../src_learnopgl/7.light_plane.fs");

    // TEXTURES
    unsigned int concreteTexture = loadTexture("../../image/concreteTexture.png", true);
